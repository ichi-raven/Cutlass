            ...
            for(size_t i = 0; i < sets.size(); ++i)
            {
                for(size_t j = 0; j < sets[i]->binding_count; ++j)
                {
                    ...
                    switch (sets[i]->bindings[j]->descriptor_type)
                    {
                        ...
                        case SPV_REFLECT_DESCRIPTOR_TYPE_UNIFORM_BUFFER             : srt = ShaderResourceType::eUniformBuffer; break;
                    ...
                    case SpvOpTypeVector: 
                    {
                        switch (inputVar->type_description->traits.numeric.scalar.width) 
                        {
                            case 32: 
                            {
                                ...
                                {
                                    case 2: mInputVariables[i].first = ResourceType::eF32Vec2; break;
                                    case 3: mInputVariables[i].first = ResourceType::eF32Vec3; break;
                                    case 4: mInputVariables[i].first = ResourceType::eF32Vec4; break;
                                }
                            }
                            break;
                            ...
                            case 64: 
                            {
                                ...
                                {
                                    //非対応です
                                    case 2: assert(!"double2");
                                    case 3: assert(!"double3");
                                    case 4: assert(!"double4");
                                }
                            }
                            break;
                        }
                    ...
                    case SpvOpTypeVector: 
                    {
                        switch (outputVar->type_description->traits.numeric.scalar.width) 
                        {
                            case 32: 
                            {
                                ...
                                {
                                    case 2: mOutputVariables[i].first = ResourceType::eF32Vec2; break;
                                    case 3: mOutputVariables[i].first = ResourceType::eF32Vec3; break;
                                    case 4: mOutputVariables[i].first = ResourceType::eF32Vec4; break;
                                }
                            }
                            break;
